    ...
    public class MySqlContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Product>().HasData(new Product
            {
                ...
                Price = new decimal(48.74),
                Description = "Camiseta Dragon Ball branca",
                ImageUrl = "https://github.com/marceloxneves/geek-shopping/blob/main/ShoppingImages/13_dragon_ball.jpg?raw=true",
                CategoryName = "Moda"
            });
